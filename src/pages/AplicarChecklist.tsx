...
const AplicarChecklist = () => {
  ...
  const gerarPDF = async () => {
    ...
    pdf.setFontSize(16);
    pdf.text("Relatório de Inspeção Sanitária", 105, yPos, { align: "center" });
    yPos += 15;
    ...
    yPos += 6;
    const endereco = [clienteAtual.rua, clienteAtual.bairro, clienteAtual.cidade, clienteAtual.estado]
      .filter(Boolean)
      .join(", ");
            ...
            <Card className="shadow-md">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <SignatureCanvas
                    label="Assinatura do RT (Obrigatória)"
                    onSave={setAssinaturaRT}
                    signatureData={assinaturaRT}
                  />
                  <SignatureCanvas
                    label="Assinatura do Representante do Cliente (Obrigatória)"
