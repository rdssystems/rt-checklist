  ...
  return <div className="min-h-screen flex items-center justify-center bg-gradient-subtle px-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold">Checklist - rDs Systems</CardTitle>
          <CardDescription>Sistema de Gestão para RTs</CardDescription>
        </CardHeader>
            ...
            <form onSubmit={handleSignUp}>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="nome-rt" type="text" placeholder="Seu nome completo" value={nomeRT} onChange={e => setNomeRT(e.target.value)} required />
                </div>
                <div className="space-y-2">
              ...
              <CardFooter>
                <Button type="submit" className="w-full bg-gradient-accent hover:opacity-90 transition-opacity" disabled={loading}>
